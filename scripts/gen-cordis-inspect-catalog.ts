...
/** Client projection omits the Host-only downstream service exclusions. */
const CLIENT_CATALOG_POLICY: CordisCatalogPolicy = {
  ...CORDIS_CATALOG_POLICY,
  serviceExclusions: new Set(),
}
...
function main(): void {
  const { projector, model } = projectCordisCatalog(root, CLIENT_CATALOG_POLICY, 'client')
