...
The application version mirrors [`apps/cli/package.json`](../cli/package.json). [`sync-upstream.yml`](../../.github/workflows/sync-upstream.yml) updates it after each upstream merge, and [`desktop-release.yml`](../../.github/workflows/desktop-release.yml) validates the version before publishing artifacts.
